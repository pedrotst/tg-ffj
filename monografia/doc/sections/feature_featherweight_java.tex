...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item Case $C@feat$ is the first refinement we have $mtype(m, C) = mtype_R(m, C@feat)$, by well- formedness of method in a class (\Cref{method-typing}) we have $override(m,~C,~Ds~'\rightarrow~D_0')$
