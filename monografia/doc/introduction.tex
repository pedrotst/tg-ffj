...
Nevertheless, none of the existing efforts for specifying \gls{FFJ} type system have been mechanized to date.
...
In this paper, we present an implementation of \gls{FJ} which we extend with \gls{FFJ} using \texttt{Coq}.
